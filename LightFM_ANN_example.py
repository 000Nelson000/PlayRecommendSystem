...
get_ipython().run_cell_magic('timeit', '', 'nearest_movies_Annoy(90, t, print_output=False)')
...
get_ipython().run_cell_magic('timeit', '', 'nearest_movies_nms(90, nms_idx, n=10, print_output=False)')
...
get_ipython().run_cell_magic('timeit', '', 'sample_recommendation_original(model, movielens, [3, 25, 450], print_output=False)')


# In[213]:


get_ipython().run_cell_magic('timeit', '', 'sample_recommendation([3,25,450], model, movielens, print_output=False)')
